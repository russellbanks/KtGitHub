...
class GHUser(
    ...
    val type: String,
    val sideAdmin: Boolean? = null,
    val url: String,
    val company: String? = null,
    @SerialName("blog") val blogUrl: String? = null,
    val location: String? = null,
    @SerialName("hireable") val isHireable: Boolean? = null,
    val bio: String? = null,
    val twitterUsername: String? = null,
    @SerialName("public_repos") val publicRepositoriesCount: Int? = null,
    @SerialName("public_gists") val publicGistsCount: Int? = null,
    @SerialName("followers") val followersCount: Int? = null,
    @SerialName("following") val followingCount: Int? = null,
    val createdAt: Instant? = null,
    val updatedAt: Instant? = null,
    @SerialName("private_gists") val privateGistsCount: Int? = null
) : GitHubObject() {
    suspend fun fetchStarred(
     ...
     */
    suspend fun fetchRepositories(): GHResult<List<GHRepository>> = getWithConfig(reposUrl)
     ...
     */
    suspend fun fetchOrganizations(): GHResult<List<GHOrganization>> = getWithConfig(organizationsUrl)
